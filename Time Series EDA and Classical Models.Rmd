...
ggplot() +
  ...
  geom_line(data = a3_smoothed_data, aes(x = Date, y = ma, color = DayOfWeek), linewidth = 1) +
  theme_bw() +
...
ggplot() +
  geom_point(data = accidents, aes(x = Date, y = Freq, color = DayOfWeek), size = 0.3) +
  geom_line(data = accidents, aes(x = Date, y = Freq, color = DayOfWeek), linewidth = 0.3) +
  geom_line(data = a4_smoothed_data, aes(x = Date, y = ma, color = DayOfWeek), linewidth = 1) +
  theme_bw() +
